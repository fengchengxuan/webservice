...
<div>
    ...
    <!--中间内容-->
        <div id="content" style="height: 4530px">
            <%--面包屑--%>
                <div style="width: 1200px;margin: 66px auto 0 auto;position: relative;top: -70px;">
                    <span ><a href="http://www.fengcheng7080.com/" target="_Blank" style="font-size: 14px;color: #666;">首页</a></span>
                    <span>></span>
                    <span style="font-size: 14px;color: #666;">您从我们这得到什么</span>
            ...
            <div class="content-jpg">
                ...
                <div style="position: relative;top: -40px;margin-top: 30px;height: 415px" class="content-jpg-dw-p1">
                    <p class="content-jpg-dw-p1-p1" style="line-height: 45px">我们敢承诺白纸黑字、立据为证，<span  class="content-jpg-dw-p1-p1-lan">它就是四书</span></p>
                    <div class="content-jpg-dw-box content-jpg-dw-box1">
                        ...
                        <h4 style="position: relative;top: -15px">四书</h4>
                    ...
                    <div class="content-jpg-dw-box content-jpg-dw-box3">
                        ...
                        <h4 style="position: relative;top: -4px">六做</h4>
                    ...
                    <div class="content-jpg-dw-box content-jpg-dw-box4">
                        ...
                        <h4 style="position: relative;top: -8px;">两定</h4>
    ...
    top: -76px;z-index: 99;">
                ...
                <span style="position:relative;top: -42px"> 数据-告诉-你-结果=我们付出/换来您的认可</span>
                </span>
                    <div style="padding: 10px 0;height: 742px;position: relative;top: -10px;background:url(${ctx}/static/front/images/dow-bg111.png) no-repeat">

                        <table style="color:#fff;position: relative;top: 63px;left:502px;border: 0;width: 504px" class="table-bgcolor Dowhat-table">
                            ...
                            <tr class="margin-top0" style="background: transparent;border: 0">
                                ...
                                <%--<td>0</td>--%>
                                <%--<td>1</td>--%>
                                <td style="width:164px;height: 57px;line-height: 57px;color: #F89D0A;font-size: 20px" id="numDiv">688</td>
                                <td style="width:164px;height: 57px;line-height: 57px;color: #F89D0A;font-size: 20px" id="numDiv1">1688</td>
                                <td style="width:164px;height: 57px;line-height: 57px;color: #F89D0A;font-size: 20px" id="numDiv2">16888</td>
                            ...
                            <tr style="background: transparent;border: 0">
                                ...
                                <%--<td>0</td>--%>
                                <%--<td>1</td>--%>
                                <td style="width:164px;height: 57px;line-height: 57px;color: #F89D0A;font-size: 20px"  id="numDiv3">5</td>
                            ...
                            <tr style="background: transparent;border: 0">
                                ...
                                <%--<td>0</td>--%>
                                <%--<td>1</td>--%>
                                <td style="width:164px;height: 57px;line-height: 57px;color: #F89D0A;font-size: 20px" id="numDiv6">5</td>
                            ...
                            <tr style="background: transparent;border: 0">
                                ...
                                <%--<td>0</td>--%>
                                <%--<td>1</td>--%>
                                <td style="width:164px;height: 57px;line-height: 57px;color: #F89D0A;font-size: 20px" id="numDiv9">25</td>
                            ...
                            <tr style="background: transparent;border: 0">
                                ...
                                <%--<td>0</td>--%>
                                <%--<td>1</td>--%>
                                <td style="width:164px;height: 57px;line-height: 57px;color: #F89D0A;font-size: 20px" id="numDiv12">35</td>
                            ...
                            <tr style="background: transparent;border: 0">
                                ...
                                <%--<td>0</td>--%>
                                <%--<td>1</td>--%>
                                <td style="width:164px;height: 57px;line-height: 57px;color: #F89D0A;font-size: 20px" id="numDiv15">45</td>
                            ...
                            <tr style="background: transparent;border: 0">
                                ...
                                <%--<td>0</td>--%>
                                <%--<td>1</td>--%>
                                <td style="width:164px;height: 57px;line-height: 57px;color: #F89D0A;font-size: 20px" id="numDiv18">80</td>
                            ...
                            <tr style="background: transparent;border: 0">
                                ...
                                <%--<td>0</td>--%>
                                <%--<td>1</td>--%>
                                <td style="width:164px;height: 57px;line-height: 57px;color: #F89D0A;font-size: 20px" id="numDiv21">50</td>
                            ...
                            <tr style="background: transparent;border: 0">
                                ...
                                <%--<td>0</td>--%>
                                <%--<td>1</td>--%>
                                <td style="width:164px;height: 57px;line-height: 57px;color: #F89D0A;font-size: 20px" id="numDiv24">3</td>
                            ...
                            <tr style="background: transparent;border: 0">
                                ...
                                <%--<td>0</td>--%>
                                <%--<td>1</td>--%>
                                <td style="width:164px;height: 57px;line-height: 57px;color: #F89D0A;font-size: 20px" id="numDiv27">145</td>
                            ...
                            <tr style="background: transparent;border: 0">
                                ...
                                <tr style="background: transparent;border: 0">
                                    ...
                                    <%--<td>0</td>--%>
                                    <%--<td>1</td>--%>
                                    <td style="width:164px;height: 46px;line-height: 46px;color: #F89D0A;font-size: 20px" id="numDiv33">50</td>
...
<!--产品 立即购买-->
                <p class="content-jpg-dw-p1-p1" style="letter-spacing: 0;line-height: 66px">
                    您提要求，我们帮您实现企业及品牌（产品）的互联网+，中国制造+联盟=<span class="content-jpg-dw-p1-p1-lan">您说了算</span>
                </p>
                <div style="width: 100%;height: 100%;">
             <div id="type1" class="content-right-text-order1" style="background: #f8f8f8;">
                 <p style="font-size: 45px;font-family: '微软雅黑',sans-serif;">敬请期待..</p>
                    </div>

             <div id="type2"  class="content-right-text-order1" style="background: #f8f8f8;">
                 <p style="font-size: 45px;font-family: '微软雅黑',sans-serif;">敬请期待..</p>
                    </div>

             <div id="type3" class="content-right-text-order1" style="background: #f8f8f8;">
                 <p style="font-size: 45px;font-family: '微软雅黑',sans-serif;">敬请期待...</p>
                    </div>

             <div id="type4" class="content-right-text-order1" style="background: #f8f8f8;">
                 <p style="font-size: 45px;font-family: '微软雅黑',sans-serif;">敬请期待..</p>
                    </div>

             <div id="type5" class="content-right-text-order1" style="background: #f8f8f8;">
                 <p style="font-size: 45px;font-family: '微软雅黑',sans-serif;">敬请期待..</p>
                    </div>

             <div id="type6" class="content-right-text-order1" style="background: #f8f8f8;">
                 <p style="font-size: 45px;font-family: '微软雅黑',sans-serif;">敬请期待..</p>
                    </div>

             <div id="type7" class="content-right-text-order1" style="background: #f8f8f8;">
                 <p style="font-size: 45px;font-family: '微软雅黑',sans-serif;">敬请期待..</p>
                    </div>

             <div id="type8" class="content-right-text-order1" style="background: #f8f8f8;">
                 <p style="font-size: 45px;font-family: '微软雅黑',sans-serif;">敬请期待..</p>

                    </div>

             <div id="type9" class="content-right-text-order1" style="background: #f8f8f8;">
                 <p style="font-size: 45px;font-family: '微软雅黑',sans-serif;">敬请期待..</p>
                    </div>

             <div id="type10" class="content-right-text-order1" style="background: #f8f8f8;">
                 <p style="font-size: 45px;font-family: '微软雅黑',sans-serif;">敬请期待..</p>
                    </div>

             <div id="type11" class="content-right-text-order1" style="background: #f8f8f8;">
                 <p style="font-size: 45px;font-family: '微软雅黑',sans-serif;">敬请期待..</p>
                    </div>

             <div id="type12" class="content-right-text-order1" style="background: #f8f8f8;">
                 <p style="font-size: 45px;font-family: '微软雅黑',sans-serif;">敬请期待..</p>
                    </div>
                </div>
...
<!--八桂之家-->
                <div style="width: 1200px;height: 109px;margin: 25px auto" class="sili">
                    <a href="">
...
<script type="text/javascript">
    ...
    var map2 ="${ctx}/static/front/images/a2.jpg";
    var map3 ="${ctx}/static/front/images/a3.jpg";
    var map4 ="${ctx}/static/front/images/a4.jpg";
    var map5 ="${ctx}/static/front/images/a5.jpg";
    var map6 ="${ctx}/static/front/images/a6.jpg";
    var map7 ="${ctx}/static/front/images/a7.jpg";
    var map8 ="${ctx}/static/front/images/a8.jpg";
    var map9 ="${ctx}/static/front/images/a9.jpg";
    var map10 ="${ctx}/static/front/images/a10.jpg";
    var map11 ="${ctx}/static/front/images/a11.jpg";
    var map12 ="${ctx}/static/front/images/a12.jpg";
    var proList;
    //页面加载激活  查询所有产品
    $(document).ready(function () {
        $.ajax({
    ...
    function showProData(data) {
        ...
        for(var i=0;i<data.length;i++){
            if(data[i].proType=="develop") {
                ...
                $("#type1").empty();
                //图片
                var mapData="<img src=\""+map1+"\" onclick=\"proMation("+i+",'"+type+"','"+demand+"','"+proSerice+"')\">";
                //标题 关键词
        ...
        for(var i=0;i<data.length;i++){
            if(data[i].proType=="plan") {
                ...
                $("#type2").empty();
                //图片
                var mapData="<img src=\""+map2+"\" onclick=\"proMation("+i+",'"+type+"','"+demand+"','"+proSerice+"')\">";
                //标题 关键词
        ...
        for(var i=0;i<data.length;i++){
            if(data[i].proType=="marketing") {
                ...
                $("#type3").empty();
                //图片
                var mapData="<img src=\""+map3+"\" onclick=\"proMation("+i+",'"+type+"','"+demand+"','"+proSerice+"')\">";
                //标题 关键词
                var titleData="<p style=\"font-size: 14px;font-family: '微软雅黑';\"><a href='javascript:void(null)' onclick=\"proMation("+i+",'"+type+"','"+demand+"','"+proSerice+"')\" >"+data[i].proTitle+"</a></p>"+
                    "<p style=\"font-size: 15px;font-family: '微软雅黑';text-align: center;margin: 0 auto;margin-top: 8px;color: #ED0F0F;line-height: 22px;\">虚拟的internet其实是传统广告宣传新产物，两者结合更能广而告之</p>";
                //付款
        ...
        for(var i=0;i<data.length;i++){
            if(data[i].proType=="popularize") {
                ...
                $("#type4").empty();
                //图片
                var mapData="<img src=\""+map4+"\" onclick=\"proMation("+i+",'"+type+"','"+demand+"','"+proSerice+"')\">";
                //标题 关键词
                var titleData="<p style=\"font-size: 14px;font-family: '微软雅黑';\"><a href='javascript:void(null)' onclick=\"proMation("+i+",'"+type+"','"+demand+"','"+proSerice+"')\" >"+data[i].proTitle+"</a></p>"+
                    "<p style=\"font-size: 15px;font-family: '微软雅黑';text-align: center;margin: 0 auto;margin-top: 8px;color: #ED0F0F;line-height: 22px;\">虚拟的internet其实是传统广告宣传新产物，两者结合更能广而告之</p>";
                //付款
        ...
        for(var i=0;i<data.length;i++){
            if(data[i].proType=="document") {
                ...
                $("#type5").empty();
                //图片
                var mapData="<img src=\""+map5+"\" onclick=\"proMation("+i+",'"+type+"','"+demand+"','"+proSerice+"')\">";
                //标题 关键词
                var titleData="<p style=\"font-size: 14px;font-family: '微软雅黑';\"><a href='javascript:void(null)' onclick=\"proMation("+i+",'"+type+"','"+demand+"','"+proSerice+"')\" >"+data[i].proTitle+"</a></p>"+
                    "<p style=\"font-size: 15px;font-family: '微软雅黑';text-align: center;margin: 0 auto;margin-top: 8px;color: #ED0F0F;line-height: 22px;\">虚拟的internet其实是传统广告宣传新产物，两者结合更能广而告之</p>";
                //付款
        ...
        for(var i=0;i<data.length;i++){
            if(data[i].proType=="video") {
                ...
                $("#type6").empty();
                //图片
                var mapData="<img src=\""+map6+"\" onclick=\"proMation("+i+",'"+type+"','"+demand+"','"+proSerice+"')\">";
                //标题 关键词
                var titleData="<p style=\"font-size: 14px;font-family: '微软雅黑';\"><a href='javascript:void(null)' onclick=\"proMation("+i+",'"+type+"','"+demand+"','"+proSerice+"')\" >"+data[i].proTitle+"</a></p>"+
                    "<p style=\"font-size: 15px;font-family: '微软雅黑';text-align: center;margin: 0 auto;margin-top: 8px;color: #ED0F0F;line-height: 22px;\">虚拟的internet其实是传统广告宣传新产物，两者结合更能广而告之</p>";
                //付款
        ...
        for(var i=0;i<data.length;i++){
            if(data[i].proType=="seo") {
                ...
                $("#type7").empty();
                //图片
                var mapData="<img src=\""+map7+"\" onclick=\"proMation("+i+",'"+type+"','"+demand+"','"+proSerice+"')\">";
                //标题 关键词
                var titleData="<p style=\"font-size: 14px;font-family: '微软雅黑';\"><a href='javascript:void(null)' onclick=\"proMation("+i+",'"+type+"','"+demand+"','"+proSerice+"')\" >"+data[i].proTitle+"</a></p>"+
                    "<p style=\"font-size: 15px;font-family: '微软雅黑';text-align: center;margin: 0 auto;margin-top: 8px;color: #ED0F0F;line-height: 22px;\">虚拟的internet其实是传统广告宣传新产物，两者结合更能广而告之</p>";
                //付款
        ...
        for(var i=0;i<data.length;i++){
            if(data[i].proType=="media") {
                ...
                $("#type8").empty();
                //图片
                var mapData="<img src=\""+map8+"\" onclick=\"proMation("+i+",'"+type+"','"+demand+"','"+proSerice+"')\">";
                //标题 关键词
                var titleData="<p style=\"font-size: 14px;font-family: '微软雅黑';\"><a href='javascript:void(null)' onclick=\"proMation("+i+",'"+type+"','"+demand+"','"+proSerice+"')\" >"+data[i].proTitle+"</a></p>"+
                    "<p style=\"font-size: 15px;font-family: '微软雅黑';text-align: center;margin: 0 auto;margin-top: 8px;color: #ED0F0F;line-height: 22px;\">虚拟的internet其实是传统广告宣传新产物，两者结合更能广而告之</p>";
                //付款
        ...
        for(var i=0;i<data.length;i++){
            if(data[i].proType=="baike"){
                ...
                $("#type9").empty();
                //图片
                var mapData="<img src=\""+map9+"\" onclick=\"proMation("+i+",'"+type+"','"+demand+"','"+proSerice+"')\">";
                //标题 关键词
                var titleData="<p style=\"font-size: 14px;font-family: '微软雅黑';\"><a href='javascript:void(null)' onclick=\"proMation("+i+",'"+type+"','"+demand+"','"+proSerice+"')\" >"+data[i].proTitle+"</a></p>"+
                    "<p style=\"font-size: 15px;font-family: '微软雅黑';text-align: center;margin: 0 auto;margin-top: 8px;color: #ED0F0F;line-height: 22px;\">虚拟的internet其实是传统广告宣传新产物，两者结合更能广而告之</p>";
                //付款
        ...
        for(var i=0;i<data.length;i++){
            if(data[i].proType=="operation") {
                ...
                $("#type10").empty();
                //图片
                var mapData="<img src=\""+map10+"\" onclick=\"proMation("+i+",'"+type+"','"+demand+"','"+proSerice+"')\">";
                //标题 关键词
                var titleData="<p style=\"font-size: 14px;font-family: '微软雅黑';\"><a href='javascript:void(null)' onclick=\"proMation("+i+",'"+type+"','"+demand+"','"+proSerice+"')\" >"+data[i].proTitle+"</a></p>"+
                    "<p style=\"font-size: 15px;font-family: '微软雅黑';text-align: center;margin: 0 auto;margin-top: 8px;color: #ED0F0F;line-height: 22px;\">虚拟的internet其实是传统广告宣传新产物，两者结合更能广而告之</p>";
                //付款
        ...
        for(var i=0;i<data.length;i++){
            if(data[i].proType=="data") {
                ...
                $("#type11").empty();
                //图片
                var mapData="<img src=\""+map11+"\" onclick=\"proMation("+i+",'"+type+"','"+demand+"','"+proSerice+"')\">";
                //标题 关键词
                var titleData="<p style=\"font-size: 14px;font-family: '微软雅黑';\"><a href='javascript:void(null)' onclick=\"proMation("+i+",'"+type+"','"+demand+"','"+proSerice+"')\" >"+data[i].proTitle+"</a></p>"+
                    "<p style=\"font-size: 15px;font-family: '微软雅黑';text-align: center;margin: 0 auto;margin-top: 8px;color: #ED0F0F;line-height: 22px;\">虚拟的internet其实是传统广告宣传新产物，两者结合更能广而告之</p>";
                //付款
        ...
        for(var i=0;i<data.length;i++){
            if(data[i].proType=="advertisement") {
                ...
                $("#type12").empty();
                //图片
                var mapData="<img src=\""+map12+"\" onclick=\"proMation("+i+",'"+type+"','"+demand+"','"+proSerice+"')\">";
                //标题 关键词
                var titleData="<p style=\"font-size: 14px;font-family: '微软雅黑';\"><a href='javascript:void(null)' onclick=\"proMation("+i+",'"+type+"','"+demand+"','"+proSerice+"')\" >"+data[i].proTitle+"</a></p>"+
                    "<p style=\"font-size: 15px;font-family: '微软雅黑';text-align: center;margin: 0 auto;margin-top: 8px;color: #ED0F0F;line-height: 22px;\">虚拟的internet其实是传统广告宣传新产物，两者结合更能广而告之</p>";
                //付款
