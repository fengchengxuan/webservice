...
<div id="base">
        ...
        <div class="listfy1" id="nava">
            ...
            <ul>
                <li>
                    ...
                    <div class="list-ul-text" id="type1">
                        <a href="${ctx}/dataArticles" target="_blank"><p style="color: #333;font-size: 16px">敬请期待  <span></span></p></a>
                        <p class="list-ul-textp"></p>
                        <a href="${ctx}/dataArticles" target="_blank"><p class="list-ul-textp1"><span></span></p></a>
                    </div>
                </li>
            </ul>
            <ul>
            ...
            <ul>
                <li>
                    <img src="${ctx}/static/front/images/list.jpg" alt="" class="list-img">
                    <div class="list-ul-text">
                        <a href="${ctx}/dataArticles" target="_blank"><p style="color: #333;font-size: 16px">敬请期待   <span>2017年5月20日</span></p></a>
                        <p class="list-ul-textp"></p>
                        <a href="${ctx}/dataArticles" target="_blank"><p class="list-ul-textp1"><span></span></p></a>
                    </div>
                </li>
    ...
    <script type="text/javascript">
        ...
        //文章显示
        function showfengchengData(data) {
            //我们与峰程
            if(!data.length>0){
                return ;
            }
           ...
           var map="${ctx}/static/front/images/list.jpg";
            ...
            function totalPage(fengcheng) {//显示总页数
                var num=fengcheng.length;
                $.ajax({
                    url : '${ctx}/Article/showTotal',
                    data:"num="+num,
