                ...
                <div class="tab" role="tabpanel">
                    ...
                    <div class="tab-content tabs">
                        <div role="tabpanel" class="tab-pane fade in active" id="Section1">
                                <div class="right-top"><img src="${ctx}/static/front/images/lisa.png" alt=""><span data-toggle="modal" data-target="#myModa110">我要投诉</span></div>
                                <table>
                                    <thead>
                                    <tr>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="Section2">
                            <div class="right-top"><img src="${ctx}/static/front/images/lisa.png" alt=""><span data-toggle="modal" data-target="#myModa111">我要提建议</span></div>
                            <table>
                                <thead>
                                <tr>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="Section3" >
                            ...
                            <div style="padding: 15px 0 ">
                                    <div class="tab-Section3-jpg"><img src="${ctx}/static/front/images/man.png" alt=""></div>
                            ...
                            <div style="padding: 15px 0 ">
                                    <div class="tab-Section3-jpg"><img src="${ctx}/static/front/images/jman.png" alt=""></div>
                                    <div class="tab-Section3-box">
                            ...
                            <div style="padding: 15px 0 ">
                                    <div class="tab-Section3-jpg"><img src="${ctx}/static/front/images/wman.png" alt=""></div>
                                    <div class="tab-Section3-box">
    ...
    <div class="modal-dialog" >
        <div class="modal-content" style="width:600px;height: 400px; font-size: 14px;color: #656565">
            ...
            <div class="tab-mk"><span>建议方</span>
                <input type="text" placeholder="" style="width: 220px;height: 40px;border: 1px solid #ccc;background: #F1F1F1">
            </div>
            <div style="width: 220px;height: 40px;border: 0" class="tab-mk">
                ...
                <div style="position: absolute;top: 350px;left: 160px;">
                    <button type="button"  style="width:160px;height: 40px;background: #00A1E5;border-radius:8px; color: #fff;border: 0;font-size: 16px">
                        提交投诉
                    </button>
                    <button type="button"
                            data-dismiss="modal" style="width: 100px;height: 40px;border-radius:8px; color: #00A1E5;border: 0;margin-left: 15px;background: transparent;">
                        取消
                    </button>
                </div>
            </div>
