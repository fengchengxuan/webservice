    ...
    <div class="inner" style="height: 1126px">
        ...
        <div class="draftartbox">
            <table class="artable">
                ...
                <th style="width: 103px;border-left: 1px solid #24a1e4">订单状态</th>
            ...
            <div class="darbtnbox">
                <button class="thisfresh" style="cursor: pointer">当前页一键刷新</button>
                <button class="allfresh" style="cursor: pointer">全部文章一键刷新</button>
            </div>
            <div class="darpages">
                <span>共10页</span>&nbsp;
                <span>1</span>
