...
<div class="contener" style="overflow: hidden">
    ...
    <div class="contentbox">
        ...
        <div class="inner inner-1" style=" width: 980px;height: 70px;
            ...
            <div class="title" style="margin-top: 8px;">&nbsp;&nbsp;&nbsp;&nbsp;未答咨询</div>
        </div>
        ...
        <div class="inner inner-2" style=" width: 980px;height: 1300px;
            ...
            <ul style="color:white;">
                ...
                <li style="text-align:center;float: left;height: 43px;line-height: 43px;border-left: 1px solid #208ec9;width:135px;font-weight: 400">未答咨询</li>
        ...
        overflow:hidden;white-space:nowrap;width:110px;" title="这个学校里的老师好吗"  disabled="disabled" ></td>
                        ...
                        <td style="width:144px;"><span style="color: #0D63EF;font-size: 12px;">修改</span> | <span style="color: red;font-size: 12px;">删除</span></td>
                        <td style="width:109px">未处理</td>
                    </tr>
                </table>
                <div>
