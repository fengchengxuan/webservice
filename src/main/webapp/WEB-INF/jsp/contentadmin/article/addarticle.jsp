...
<head>
   ...
   <link rel="stylesheet" href="${ctx}/static/background/css/top.css">
    ...
    <style>
        ...
        .contener .inner .setnewsbox .end{top:-4px}
    .Selected{
        border-radius: 3px;
        padding-left: 4px;
        ...
        <div class="inner" style="height: auto;padding-bottom: 110px">
            ...
            <div class="setnewsbox">
                <div class="newstitle">
                    ...
                    <input type="text" placeholder="" id="articleTitle">
                ...
                <div class="newkeyw" style="margin: 30px 0 0 0">
                    ...
                    <input type="text" placeholder="" id="articleKey">
                ...
                <div class="abs" style="margin: 30px 0 0 0">
                    ...
                    <textarea class="abstext" placeholder="" id="articleAbstract"></textarea>
                    <p class="end" style="position: relative;top:38px">文章摘要字数不能超100个字，超出字数无法进行提交。</p>
                </div>
            </div>
...
//            document.getElementById("container").value=body;
    ...
    $("#Submit").click(function(){
        var artTitle=$("#articleTitle").val();   //文章标题
        var artKey=$("#articleKey").val();      //文章关键字
        ...
        $.ajax({
            url : '${ctx}/Article/add',
            type : 'POST',
            data : "htmlText="+htmlText+"&artTitle="+artTitle+"&artKey="+artKey+"&artAbstract="+artAbstract+"&artType="+artType,
            async:true,
            cache:false,
            dataType : 'json',
            success : function(data){
