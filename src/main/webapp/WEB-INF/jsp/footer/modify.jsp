        ...
        <div class="inner">
            ...
            <div class="navbox">
                <div class="createnav">
                    ...
                    <input type="text" placeholder="" class="c-input">
                ...
                <div class="cnav-title">
                    ...
                    <textarea placeholder="" style="border-radius: 6px;width: 406px;height: 73px;max-width: 406px;max-height: 73px;margin: 14px 0 0 30px;border: 1px solid #ccc"></textarea>
                ...
                <div class="keyw">
                    ...
                    <input type="text" placeholder="" class="key-input">
                ...
                <div class="nsetnav">
                    ...
                    <input type="text" placeholder="" class="nsetnav-input">
