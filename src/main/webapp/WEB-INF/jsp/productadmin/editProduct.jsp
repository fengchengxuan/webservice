...
<div class="contener" style="overflow: hidden">
    ...
    <div class="contentbox">
        ...
        <div class="inner" style="height: auto;padding-bottom: 100px">
            <div class="title">&nbsp;&nbsp;&nbsp;&nbsp;修改产品</div>
            <label style="font-weight: 400;height: 45px;
    margin: 20px 0 0 89px;">

                <div class="select_model">
                    <div class="Selected" id="Selected" style="margin: 0 0 0 10px;"><span id="proType" style="font-size: 12px;">全部类型</span>&nbsp;<img src="${ctx}/static/background/images/right-l.png" alt="下拉"></div>
                    <div style="display: none;left: 10px;" class="ddoli" id="ddoli">
                        <ul>
                            <li style="border-top: none">全部类型</li>
                            <li>网站建设/程序/APP研发与定制</li>
                            <li>网络计划与制定">网络计划与制定</li>
                            <li>网络营销</li>
                            <li>网络推广</li>
                            <li>网络文案</li>
                            <li>视频制作与推广</li>
            ...
            <div class="setnewsbox">
                <div class="newstitle">
                    ...
                    <input type="text" id="proTitle" placeholder="">
                    <div id="searchresult"></div>
                    <p class="end">产品标题字数不能超30个字，超出字数无法进行提交。</p>
                </div>
                <%--新的标题--%>
                <div class="newstitle" style="margin-top: 25px;">
                    <span class="head" style="letter-spacing: 5px" >新的标题</span>
                ...
                <div class="newkeyw" style="margin: 30px 0 0 0">
                    ...
                    <input type="text" id="proKey" placeholder="">
                ...
                <div class="abs" style="margin: 30px 0 0 0">
                    ...
                    <textarea class="abstext" id="proAbstract" placeholder=""></textarea>
                    <p class="end" style="position: relative;top:0">产品页摘要字数不能超100个字，超出字数无法进行提交。</p>
                </div>
                <hr/>
                <div class="fanan">

                    <div style="    margin-left: -45px;">
                         <span style="width: 128px;" class="editx-p4">
                    需求定位
                         </span>
                    ...
                    服务标准
                        ...
                        <%--<label>--%>
                            <%--<select style="margin-left: 12px;font-weight: 400;width: 60px;height: 22px;margin-top: 4px;    border: 1px solid #ccc;" id="service">--%>
                                <%--<option>体验版</option>--%>
                                <%--<option>基础版</option>--%>
                                <%--<option>加强版</option>--%>
                                <%--<option>定制版</option>--%>
                            ...
                            <%--</select>--%>
                        <%--</label>--%>
                        <label style="font-weight: 400;    height: 22px;">

                            <div class="select_model">
                                <div class="Selected" id="Selected2" style="margin: 0 0 0 10px;"><span id="service" style="font-size: 12px;width: auto">体验版</span>&nbsp;<img src="${ctx}/static/background/images/right-l.png" alt="下拉"></div>
                    ...
                    <div >
                        <p style="float: left;width: 93px;margin-left: 1px;line-height: 30px;" class="editx-p4">选择时长</p>
                        <label style="     height: 22px;font-weight: 400;
    margin-left: -100px;">
                            <%--<select name="" id="useTime" style="font-weight: 400;width: 60px;height: 22px;border: 1px solid #ccc">--%>
                                <%--<option>试客体验</option>--%>
                                <%--<option>3个月</option>--%>
                                <%--<option>6个月</option>--%>
                                <%--<option>1年</option>--%>
                                <%--<option>2年</option>--%>
                                <%--<option>3年</option>--%>
                                <%--<option>4年</option><option>5年</option>--%>
                            <%--</select>--%>

                            <div class="select_model">
                                <div class="Selected" id="Selected3"><span id="useTime" style="font-size: 12px;width: auto">试客体验</span>&nbsp;<img src="${ctx}/static/background/images/right-l.png" alt="下拉"></div>
                                <div style="display: none" class="ddoli" id="ddoli3">
                                    <ul>
                                        <li style="line-height: 20px">3个月</li>
                                        <li>6个月</li>
                                        <li>1年</li>
                                        <li style="line-height: 20px">2年</li>
                                        <li style="line-height: 20px">3年</li>
                                        <li style="line-height: 20px">4年</li>
                                        <li style="line-height: 20px">5年</li>
                                    </ul>
                                </div>
                            </div>
                        </label>
                        <input type="button" id="showInfo" value="显示信息"/>
                    </div>
                    <hr/>
                    <div>
                        <span style="width: 85px;margin-right: -2px;position: relative;left: -6px;">
                    新的需求名称
                         </span>
                        <input type="text" name=""  id="newDemand" placeholder="">
                    </div>

                    <div style="margin-left: 12px;margin-bottom: 25px;">
                        <div style="float: left;line-height: 39px;">
                         <span style="line-height: 38px">
                        优惠
                         </span>
                            <label style="font-weight: 400;">
                                <input id="preferential" type="text" style="width: 100px; margin: 0 0 0 3px;">元
                            </label>
                        </div>
                        <div style="float: left;line-height:39px">
                         <span style="line-height: 38px">
                        价格
                            ...
                            <label style="font-weight: 400;">
                                <input id="price" type="text" style="width: 100px; margin: 0 0 0 3px;">元
                            </label>
                        </div>
                        <div style="float: left;line-height:39px">
                            <ul class="pay">
                                <li class="num">
                                    <p style="float: left;width: 82px;text-align: right">总数</p>
                                    <input type="text" id="num" style="width: 70px;margin: -2px 0 0 10px;margin: 0 0 0 3px;" placeholder="">
                                </li>
                    ...
                    <span style="width: 121px;margin-left: -44px;    position: relative;left: -5px;">
                    产品时间配备范围
                    </span>
                    ...
                    <div>
                    <span style="width: 84px;position: relative;left: -5px;">
                    专属客服经理
                    </span>
                    ...
                    技术服务
                        ...
                        <textarea style="margin-left: 11px;width: 507px;height: 77px;resize:none;border: 1px solid #ccc;" id="technical_service" placeholder=""></textarea>
                    </div>
                    ...
                    赠送
                        ...
                        <textarea style="margin-left: 11px;width: 507px;height: 77px;resize:none;border: 1px solid #ccc;"  placeholder=""></textarea>
                    </div>
...
//            alert(1)
   ...
   //提交
    $("#Submit").click(function(){
        ...
        var proAbstract=$("#proAbstract").val();
        ...
        if($("#proTitle").val()!=null &&$("#proTitle").val()!=""){
            ...
            newProTitle=$("#newTitle").val();
            if(!flag){
                $.ajax({
                    url : '${ctx}/Product/update',
                    type : 'POST',
                    data : "htmlText="+htmlText+"&proTitle="+proTitle+"&proKey="+proKey+"&proAbstract="+proAbstract+"&proType="+proType+"&newProTitle="+newProTitle,
                    async:true,
                    cache:false,
                    dataType : 'json',
                    success : function(data){
                        if(data!=null){
                            alert(data);
                            window.location.href="${ctx}/admin/editproduct";
                        }
                    }
                })
            }else{
                {
                    $.ajax({
                        ...
                        type : 'POST',
                        data : "htmlText="+htmlText+"&proTitle="+proTitle+"&proKey="+proKey+"&proAbstract="+proAbstract+"&proType="+proType+"&newProTitle="+newProTitle+
                        "&timeValue="+  $("#useTime").val()+
                        "&oldDemand="+ $("#demand").val()+
                        "&newDemand="+$("#newDemand").val()+
                        "&proService=" +$("#service").val()+
                        "&price="+$("#price").val()+
                        "&num= "+  $("#num").val()+
                        "&hard_Configuration="+ $("#hard_Configuration").val()+
                        "&soft_Configuration="+ $("#soft_Configuration").val()+
                        "&personnel= "+ $("#personnel").val()+
                        "&time_Allocation="+ $("#time_Allocation").val()+
                        "&user_range="+ $("#user_range").val()+
                        "&dataInfo="+ $("#dataInfo").val()+
                        "&preferential= "+ $("#preferential").val()+
                        "&pro_manager= "+ $("#pro_manager").val()+
                        "&technical_service="+ $("#technical_service").val()+
                        "&serviceGuarante="+ $("#serviceGuarante").val(),
                        async:true,
                        cache:false,
                        dataType : 'json',
                        success : function(data){
   ...
   //显示数据
    function showProData(data,i){
       ...
       var proKey=data[i].proKey;
       var proAbstract=data[i].proAbstract;
       var htmlText=data[i].htmlText;
       if(proType=="develop"){
           $("#proType").text("网站建设/程序/APP研发与定制");
       }else if(proType=="seo"){
           $("#proType").text("搜索优化");
       }else if(proType=="popularize"){
           $("#proType").text("网络推广");
       }else if(proType=="marketing"){
           $("#proType").text("网络营销");
       }else if(proType=="data"){
           $("#proType").text("数据统计");
       }else if(proType=="plan"){
           $("#proType").text("网络计划与制定");
       }else if(proType=="document"){
           $("#proType").text("文案");
       }else if(proType=="media"){
           $("#proType").text("网络媒体");
       }else if(proType=="baike"){
           $("#proType").text("词条/百科");
       }else if(proType=="operation"){
           $("#proType").text("网络运营");
       }else if(proType=="advertisement"){
           $("#proType").text("网络传媒及线上线下各类广告投放");
       }else if(proType=="video"){
           $("#proType").text("视频制作与推广");
       }
       $("#proKey").val(proKey);
       $("#proAbstract").val(proAbstract);
    ...
    function emptyData() {
       ...
       $("#proKey").val(null);
       $("#proTitle").val(null);
       $("#proAbstract").val(null);
       $("#newTitle").val(null);
       ue.setContent('开始编辑文字');
   }

       $("#proTitle").keydown(function(){
           $("#proTitle").css("background-color","#c9ff8d");
       });
   ...
   //查数据
       ...
       function showTitle(data) {
          ...
          $(".line").click(function () {
               ...
               $("#proTitle").val(data[num].proTitle)
  ...
  $(document).ready(function(){
       code='${param.code}';
       pro_service='${param.service}';
       pro_time='${param.time}';
       pro_demand='${param.demand}';
      if(code!=null && code!=""){
          flag=false;
          $.ajax({
              ...
              success : function(data){
                  if(data!=null){
                      if(data.length>0){
                          $("#proTitle").val(data[0].proTitle);
                          oldProTitle=$("#proTitle").val();
                          showProData(data,0);
                          if(pro_demand!=null&&pro_demand!=""){ //判断是否显示需求信息
                              $("#demand").val(pro_demand);
                              $("#showInfo").click();
                          }
                      }
                  }
   ...
   $("#showInfo").click(function () {
       $.ajax({
           url : '${ctx}/Product/showInfo',
           type : 'POST',
           data : "proTitle="+$("#proTitle").val()+"&useTime="+ pro_time+"&demand="+ pro_demand+"&proService="+pro_service,
           async:true,
           cache:false,
           dataType : 'json',
           success : function(data){
               if(data!=null){
                   $("#useTime").text(pro_time);
                   $("#service").text(pro_service);
                   showProInfo(data);
                   return;
               }
           }
   ...
   function showProInfo(data){
       flag=true;
       $("#price").val(data.servicePrice);
       $("#num").val(data.totalNum);
       $("#hard_Configuration").val(data.hard_Configuration);
       $("#soft_Configuration").val(data.soft_Configuration);
       $("#personnel").val(data.personnel);
       $("#time_Allocation").val(data.time_Allocation);
       $("#user_range").val(data.user_range);
       $("#dataInfo").val(data.data);
       $("#preferential").val(data.preferential);
       $("#pro_manager").val(data.pro_manager);
       $("#technical_service").val(data.technical_service);
       $("#serviceGuarante").val(data.serviceGuarante);
   }
</script>
<script>
    $(document).ready(function () {
