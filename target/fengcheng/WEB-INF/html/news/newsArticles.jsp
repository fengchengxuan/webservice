                        ...
                        success : function(data) {
                            if(data!=null && data!="") {
                                ...
                                var row="  <div style=\"position: relative;z-index: 99\">" +
                                    "        <div class=\"h1\">"+data[0].newsTitle+"</div>" +
                                    "    <div class=\"Article-right-tt\"><span>编辑者："+data[0].userName+"</span><span>发布时间："+data[0].crateDate+"</span>   <span>浏览次数："+data[0].newsBrowser+"</span>          分享<span style=\"cursor: pointer\">" +
                                    "            <img src=\""+qq+"\" alt=\"\">" +
                                    "            <img src=\""+wx+"\" alt=\"\">" +
                                    "            <img src=\""+wb+"\" alt=\"\">" +
                                    "            <img src=\""+xlwb+"\" alt=\"\">" +
