...
<div class="contentbox" style="height: 900px">
    ...
    <div class="inner" style="height: 1126px">
        ...
        <div class="draftartbox">
            ...
            <button  style="margin:80px 0 0 260px;width:166px;height: 40px; border-radius:6px;border: 0;color:#fff;background: #24a1e4;">提交</button>
            <button  style="margin:80px 0 0 110px;width:166px;height: 40px; border-radius:6px;border: 0;color:#fff;background: #24a1e4;" type="reset">取消</button>
            </form>
        </div>
