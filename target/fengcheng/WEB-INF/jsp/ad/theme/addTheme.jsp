    ...
    <div class="contentbox" style="height: auto;">
        ...
        <div class="inner inner-1" style=" width: 980px;height:auto;background-color: white;padding: 0 0 30px 0;">
            ...
            <div class="title-tb">
                ...
                <span class="title-tb-2">可自定义专题名称</span>
            </div>
            <!--Title 专题标题-->
                        ...
                        <div style="width: 283px;height: 37px;background: url(${ctx}/static/background/images/add-images-bg.jpg);float: left;margin-left: 20px;font-size: 14px">
                            ...
                            <div class="Stars">
                                <div class="starttwo1 block clearfix">
                                    ...
                                    <input type="hidden" id="structureVal">
                                </div>
                            </div>
                        ...
                        <div style="width: 308px;height: 37px;background: url(${ctx}/static/background/images/add-images-bg1.jpg);float: left;margin-left: 20px;font-size: 14px">
                            ...
                            <div class="Stars" >
                                <div class="starttwo2 block clearfix" id="aesthetics">
                                    <input type="hidden" id="aestheticsVal">
                        ...
                        <div style="width: 308px;height: 37px;background: url(${ctx}/static/background/images/add-images-bg1.jpg);float: left;margin-left: 20px;font-size: 14px">
                            ...
                            <div class="Stars" >
                                <div class="starttwo3 block clearfix" id="appaction">
                                    <input type="hidden" id="appactionVal"/>
                                    <div  class="star_score"></div>
                                </div>
                            </div>
                        ...
                        <div style="width: 308px;height: 37px;background: url(${ctx}/static/background/images/add-images-bg1.jpg);float: left;margin-left: 20px;font-size: 14px">
                            ...
                            <div class="Stars" >
                                <div class="starttwo5 block clearfix" id="marketing">
                                    <input type="hidden" id="marketingVal"/>
                                    <div  class="star_score"></div>
                                </div>
                            </div>
                        ...
                        <div style="width: 308px;height: 37px;background: url(${ctx}/static/background/images/add-images-bg1.jpg);float: left;margin-left: 20px;font-size: 14px">
                            ...
                            <div class="Stars" >
                                <div class="starttwo8 block clearfix" id="population">
                                    <input type="hidden" id="populationVal"/>
                                    <div  class="star_score"></div>
                                </div>
                            </div>
                        ...
                        <div style="width: 308px;height: 37px;background: url(${ctx}/static/background/images/add-images-bg1.jpg);float: left;margin-left: 20px;font-size: 14px">
                            ...
                            <div class="Stars" >
                                <div class="starttwo block clearfix" id="workReportion">
                                    <input type="hidden" id="workReportionVal"/>
...
<script>
    ...
    $(".xingxing").find("#workReportion").find("a").eq(4).click(function () {
        $("#workReportionVal").val(5);
    });
    $(".button1").click(function () {
        if($("#structureVal").val()==null || $("#structureVal").val()==""){
            return;
        }
        if( $("#aestheticsVal").val()==null ||  $("#aestheticsVal").val()==""){
            return;
        }
        if( $("#appactionVal").val()==null ||   $("#appactionVal").val()==""){
            return;
        }
        if( $("#operateVal").val()==null || $("#operateVal").val()==""){
            return;
        }
        if( $("#marketingVal").val()==null ||  $("#marketingVal").val()==""){
            return;
        }
        if( $("#copyVal").val()==null||  $("#copyVal").val()==""){
            return;
        }
        if(  $("#dataVal").val()==null ||   $("#dataVal").val()==""){
            return;
        }
        if($("#populationVal").val()==null || $("#populationVal").val()==""){
            return;
        }
        if( $("#workReportionVal").val()==null || $("#workReportionVal").val()==""){
            return;
        }
        $.ajax({
            url : '${ctx}/Special/addSpecial',
            type : 'POST',
            ...
            success : function(data){
              if(data!=null){
                  alert(data);
                  if(data=="添加成功"){
                      window.location.href="${ctx}/admin/addtheme";
                  }
              }
            }
        })
