        ...
        <div class="inner">
            ...
            <%--<div class="navbox">--%>
                <%--<div class="createnav">--%>
                    ...
                    <%--<label>--%>
                    <%--&lt;%&ndash;<select class="nav-create" name="catalog">&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<c:forEach var="nav" items="${nlist}">&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<option value="${nav.seId}">${nav.catalog}</option>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</c:forEach>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</select>&ndash;%&gt;--%>
                        <%--<select class="nav-create" name="navname">--%>
                            <%--<option>导航一</option>--%>
                            <%--<option>导航二</option>--%>
                            <%--<option>导航三</option>--%>
                            <%--<option>导航四</option>--%>
                        ...
                        <%--</select>--%>
                    <%--</label>--%>
                    <%--<input type="text" placeholder="" class="c-input" name="navname">--%>
                    <%--<span class="scatalog"></span>--%>
                <%--</div>--%>
                <%--<div class="cnav-title">--%>
                        <%--<span class="cntitle">--%>
                            <%--标&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题 ( T i t l e )--%>
                        <%--</span>--%>
                    <%--<textarea style="border-radius: 6px;width: 406px;height: 73px;max-width: 406px;max-height: 73px;margin: 14px 0 0 30px;border: 1px solid #ccc" placeholder="" name="navtitle"></textarea>--%>
                    <%--<span class="stitle" style="position: relative;top:-30px;"></span>--%>
                <%--</div>--%>
                <%--<div class="keyw">--%>
                    ...
                    <%--<span class="skeywords"> </span>--%>
                <%--</div>--%>
                <%--<div class="disc">--%>
                        <%--<span class="disctitle">--%>
                            <%--描&nbsp;述 ( Deasription )--%>
                        <%--</span>--%>
                    <%--<textarea style="border-radius: 6px;width: 406px;height: 73px;max-width: 406px;max-height: 73px;margin: 14px 0 0 30px;border: 1px solid #ccc" placeholder="" name="navdescribe" id="description"></textarea>--%>
                    <%--<span class="sdescribe" style="position: relative;top:-30px;"></span>--%>
                <%--</div>--%>
                <%--<div class="nsetnav">--%>
                        <%--<span style="font-family: '微软雅黑',sans-serif;font-size: 14px;color:#333333;line-height: 20px">--%>
                            <%--设&nbsp;&nbsp;&nbsp;置&nbsp;&nbsp;&nbsp;导&nbsp;&nbsp;&nbsp;航&nbsp;&nbsp;URL--%>
                ...
                <%--<div class="state" style="position: relative;top:20px">--%>
                    ...
                    <%--<label>--%>
                    <%--&lt;%&ndash;<select name="navstatus" class="statesel">&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<c:forEach var="status" items="${slist}">&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<option value="${status.stId}">${status.status}</option>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</c:forEach>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</select>&ndash;%&gt;--%>
                ...
                <%--<div class="opson" style="position: relative;top:40px">--%>
                    ...
                    <%--<select name="operator" id="" class="opsonselect">--%>
                        <%--<c:forEach var="operator" items="${olist}">--%>
                        <%--<option value="${operator.opId}">${operator.operator}</option>--%>
                        <%--</c:forEach>--%>
                    <%--</select>--%>
                    <%--</label>--%>
                <%--</div>--%>
